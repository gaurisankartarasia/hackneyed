...
//         className="flex items-center justify-center text-gray-100 active:scale-95 transition-all duration-500 mb-4"
//       >
//         Go back
//       </button>
//       </div>
...
//             <h2 className="text-xl lg:text-2xl font-semibold text-red-900 mb-4">Warning</h2>
...
import { RiShareBoxFill } from "react-icons/ri";
import Loader from '../../../../components/Loader';
import ROMSections from './NotesAndFlashingSection';
...
<ROMSections
          notes={romDetails.notes}
          flashingSteps={romDetails.flashingSteps}
          prevBuildSteps={romDetails.prevbuild}
        />
